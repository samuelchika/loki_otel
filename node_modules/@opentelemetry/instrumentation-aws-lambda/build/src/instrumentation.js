...
class AwsLambdaInstrumentation extends instrumentation_1.InstrumentationBase {
    ...
    _getPatchHandler(original, lambdaStartTime) {
        ...
        event, context, callback) {
            ...
            const span = plugin.tracer.startSpan(name, {
                ...
                attributes: Object.assign({ [semantic_conventions_1.SEMATTRS_FAAS_EXECUTION]: context.awsRequestId, [semantic_conventions_1.SEMRESATTRS_FAAS_ID]: context.invokedFunctionArn, [semantic_conventions_1.SEMRESATTRS_CLOUD_ACCOUNT_ID]: AwsLambdaInstrumentation._extractAccountId(context.invokedFunctionArn), [incubating_1.ATTR_FAAS_COLDSTART]: requestIsColdStart }, AwsLambdaInstrumentation._extractOtherEventFields(event)),
            }, parent);
    ...
    static _extractFullUrl(event) {
        ...
        function findAny(event, key1, key2) {
            var _a;
            return (_a = event.headers[key1]) !== null && _a !== void 0 ? _a : event.headers[key2];
        }
        ...
        answer += (_a = event.path) !== null && _a !== void 0 ? _a : event.rawPath;
